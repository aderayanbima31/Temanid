...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText editTextUsername, editTextPassword, editTextRepeatPassword,editTextPhone;
    ...
    private boolean validate(String emailStr, String password, String repeatPassword, String phone) {
        ...
        return password.length() > 0 && repeatPassword.equals(password) && matcher.find() && !phone.equals("");
    }
}
